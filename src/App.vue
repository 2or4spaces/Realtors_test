<template>
  <header>
    <header-employees></header-employees>
  </header>
...
<script>
import HeaderEmployees from "./components/HeaderEmployees.vue";
...
export default {
  name: "App",
  components: { HeaderEmployees, EmployeeCard, EmployeeProfile, PreLoader },
  data() {
    return {
